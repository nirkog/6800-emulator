...
fn match_byte_to_opcode_info(byte: u8) -> Result<OpcodeInfo, DisassemblyError> {
    let opcode_info: OpcodeInfo = match byte {
        ...
        0x10 => OpcodeInfo { opcode: Opcode::SubstractBFromA, group: OpcodeGroup::Substract, instruction_length: 1, cycles: 2, addressing_mode: AddressingMode::Inherent },
        ...
        0x80 => OpcodeInfo { opcode: Opcode::SubstractAImmediate, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 2, addressing_mode: AddressingMode::Immediate  },
        ...
        0x82 => OpcodeInfo { opcode: Opcode::SubstractWithCarryAImmediate, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 2, addressing_mode: AddressingMode::Immediate  },
        ...
        0x90 => OpcodeInfo { opcode: Opcode::SubstractADirect, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 3, addressing_mode: AddressingMode::Direct  },
        ...
        0x92 => OpcodeInfo { opcode: Opcode::SubstractWithCarryADirect, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 3, addressing_mode: AddressingMode::Direct  },
        ...
        0xA0 => OpcodeInfo { opcode: Opcode::SubstractAIndexed, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 5, addressing_mode: AddressingMode::Indexed  },
        ...
        0xA2 => OpcodeInfo { opcode: Opcode::SubstractWithCarryAIndexed, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 5, addressing_mode: AddressingMode::Indexed  },
        ...
        0xB0 => OpcodeInfo { opcode: Opcode::SubstractAExtended, group: OpcodeGroup::Substract, instruction_length: 3, cycles: 4, addressing_mode: AddressingMode::Extended  },
        ...
        0xB2 => OpcodeInfo { opcode: Opcode::SubstractWithCarryAExtended, group: OpcodeGroup::Substract, instruction_length: 3, cycles: 4, addressing_mode: AddressingMode::Extended  },
        ...
        0xC0 => OpcodeInfo { opcode: Opcode::SubstractBImmediate, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 2, addressing_mode: AddressingMode::Immediate  },
        ...
        0xC2 => OpcodeInfo { opcode: Opcode::SubstractWithCarryBImmediate, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 2, addressing_mode: AddressingMode::Immediate  },
        ...
        0xD0 => OpcodeInfo { opcode: Opcode::SubstractBDirect, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 3, addressing_mode: AddressingMode::Direct  },
        ...
        0xD2 => OpcodeInfo { opcode: Opcode::SubstractWithCarryBDirect, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 3, addressing_mode: AddressingMode::Direct  },
        ...
        0xE0 => OpcodeInfo { opcode: Opcode::SubstractBIndexed, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 5, addressing_mode: AddressingMode::Indexed  },
        ...
        0xE2 => OpcodeInfo { opcode: Opcode::SubstractWithCarryBIndexed, group: OpcodeGroup::Substract, instruction_length: 2, cycles: 5, addressing_mode: AddressingMode::Indexed  },
        ...
        0xF0 => OpcodeInfo { opcode: Opcode::SubstractBExtended, group: OpcodeGroup::Substract, instruction_length: 3, cycles: 4, addressing_mode: AddressingMode::Inherent  },
        ...
        0xF2 => OpcodeInfo { opcode: Opcode::SubstractWithCarryBExtended, group: OpcodeGroup::Substract, instruction_length: 3, cycles: 4, addressing_mode: AddressingMode::Extended  },
...
fn disassemble_operands(opcode_info: &OpcodeInfo, data: &[u8]) -> Option<Vec<OperandType>> {
    ...
    let operands = match opcode_info.opcode {
        ...
        Opcode::SubstractAImmediate => Some(vec![OperandType::AccumulatorA, operand8]),
        Opcode::CompareAImmediate => Some(vec![OperandType::AccumulatorA, operand8]),
        Opcode::SubstractWithCarryAImmediate => Some(vec![OperandType::AccumulatorA, operand8]),
        ...
        Opcode::SubstractADirect => Some(vec![OperandType::AccumulatorA, operand8]),
        Opcode::CompareADirect => Some(vec![OperandType::AccumulatorA, operand8]),
        Opcode::SubstractWithCarryADirect => Some(vec![OperandType::AccumulatorA, operand8]),
        ...
        Opcode::SubstractAIndexed => Some(vec![OperandType::AccumulatorA, operand8]),
        Opcode::CompareAIndexed => Some(vec![OperandType::AccumulatorA, operand8]),
        Opcode::SubstractWithCarryAIndexed => Some(vec![OperandType::AccumulatorA, operand8]),
        ...
        Opcode::SubstractAExtended => Some(vec![OperandType::AccumulatorA, operand16]),
        Opcode::CompareAExtended => Some(vec![OperandType::AccumulatorA, operand16]),
        Opcode::SubstractWithCarryAExtended => Some(vec![OperandType::AccumulatorA, operand16]),
        ...
        Opcode::SubstractBImmediate => Some(vec![OperandType::AccumulatorB, operand8]),
        Opcode::CompareBImmediate => Some(vec![OperandType::AccumulatorB, operand8]),
        Opcode::SubstractWithCarryBImmediate => Some(vec![OperandType::AccumulatorB, operand8]),
        ...
        Opcode::SubstractBDirect => Some(vec![OperandType::AccumulatorB, operand8]),
        Opcode::CompareBDirect => Some(vec![OperandType::AccumulatorB, operand8]),
        Opcode::SubstractWithCarryBDirect => Some(vec![OperandType::AccumulatorB, operand8]),
        ...
        Opcode::SubstractBIndexed => Some(vec![OperandType::AccumulatorB, operand8]),
        Opcode::CompareBIndexed => Some(vec![OperandType::AccumulatorB, operand8]),
        Opcode::SubstractWithCarryBIndexed => Some(vec![OperandType::AccumulatorB, operand8]),
        ...
        Opcode::SubstractBExtended => Some(vec![OperandType::AccumulatorB, operand16]),
        Opcode::CompareBExtended => Some(vec![OperandType::AccumulatorB, operand16]),
        Opcode::SubstractWithCarryBExtended => Some(vec![OperandType::AccumulatorB, operand16]),
